            ...
            <div>
                <div id = "FreelancerView">
                    <div className="display-flex justify-content-md-center mt40">
                        ...
                        <label className="col-md-2 mt10">Status Filter: </label>
                        <div className="">
                            <select
                            ...
                            {currentTodos.map((projectDetail,i) =>
                                <h5 key={i}>
                                    <div className="row row-border mt20 ml7 mr7 fs14">
                                        <Link to={'/project-details/'+projectDetail.project_id} className="col-md-2 mt10 mb10">{projectDetail.project_name}</Link>
                                        <Link to={'/view-details/'+projectDetail.emp_id} className="col-md-3 mt10 mb10">{projectDetail.emp_name}</Link>
                                        <div className="col-md-2 mt10 mb10">{projectDetail.avg_bid}</div>
                                        <div className="col-md-2 mt10 mb10">{projectDetail.bid_price}</div>
                                        <div className="col-md-1 mt10 mb10">{projectDetail.status}</div>
                                    </div>
                                </h5>)}
                        </div>
                    </div>
